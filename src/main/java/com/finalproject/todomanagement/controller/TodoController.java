package com.finalproject.todomanagement.controller;
...
import com.finalproject.todomanagement.service.ITodoService;
...
public class TodoController {
	...
	public String showTodos(ModelMap model) {
		...
		model.put("todos", todoService.getTodoOrderByTargetDateAsc());
